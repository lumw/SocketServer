...
INCLUDE= -I. -I$(ORACLE_HOME)/rdbms/demo -I$(ORACLE_HOME)/rdbms/public -I$(ORACLE_HOME)/plsql/public -I$(ORACLE_HOME)/network/public
LDFLAGS=-L. -L$(ORACLE_HOME)/lib -L$(ORACLE_HOME)/rdbms/lib -L$(ORACLE_HOME)/lib -L$(ORACLE_HOME)/network/lib -L/usr/lib -L/usr/local/lib
